...
sudo debconf-set-selections <<< "mysql-server mysql-server/root_password password Azerty123"
sudo debconf-set-selections <<< "mysql-server mysql-server/root_password_again password Azerty123"
...
echo "# bootstrap.sql #"
mysql < sql/bootstrap.sql -u root -pAzerty123
echo "# datadefinition.sql #"
mysql < sql/datadefinition.sql -u root -pAzerty123
echo "# datamanipulation.sql #"
mysql < sql/datamanipulation.sql -u root -pAzerty123
