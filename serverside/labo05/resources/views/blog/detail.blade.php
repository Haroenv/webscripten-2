...
@section('content')
    <p class="breadcrumb"><a href="{{@url('/')}}/">My Blog</a> &raquo; <a href="{{@url('/')}}/blog">Blogposts</a> &raquo; {{ $blogpost->title }}</p>
    ...
    <section class="blogpost">
        <article>
            ...
            <footer>
                <p>
                    Written by <em><a href="{{@url('/authors')}}/{{ $blogpost->user_id }}">{{ $blogpost->firstname }} {{ $blogpost->lastname }}</a></em> on <em>{{ $blogpost->date }}</em>
